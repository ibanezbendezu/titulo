...
export const LoginForm = () => {
    ...
    return (
        <div className="w-80">
            <div className="items-center justify-center md:ml-auto md:justify-end w-full space-y-5">
                ...
                <Button onClick={handleGithubLogin} variant={"normal"} className=" w-full flex items-center justify-center gap-2 rounded-lg">
                ...
                <p className="w-full text-xs text-left font-normal text-darkGray leading-3">
                    Para poder utilizar Hound de manera ilimitada, es necesario proporcionar un token para el uso de la API.
                </p>
            </div>
        </div>
    );
